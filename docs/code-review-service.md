...
> **✅ 対応済み**: [code-review-resolutions.md](./code-review-resolutions.md#code-review-servicemd-指摘10-投稿本文がそのままプロンプトへ埋め込まれる)を参照。
...
| 10 | セキュリティ | 低(将来的な検討事項) | ✅対応済み。プロンプトインジェクションへの耐性 |
